...
public abstract class Sorter {
     ...
     * @throws NullPointerException if either of {@code toSort} or {@code comp} are {@code null}
     */
     ...
     * @param comp        the comparator to use to compare elements of the list
     * @param totalToSort the minimum number of words to sort in this method; the actual number of
